...
fun main() {
    ...
    val kLow: List<Int> = listOf(1, 2, 3, 4, 5)
...
//
//    test(k, false, samples, sample9, false, linearNormalization = true)
//    test(k, true, samples, sample9, false, linearNormalization = true)
//
//    test(k, false, samples, sample9, false, zScoreNormalization = true)
//    test(k, true, samples, sample9, false, zScoreNormalization = true)


    test(kLow, false, samples, sample9, false, validation = true)
    test(kLow, true, samples, sample9, false, validation = true)

    test(kLow, false, samples, sample9, false, linearNormalization = true, validation = true)
    test(kLow, true, samples, sample9, false, linearNormalization = true, validation = true)

    test(kLow, false, samples, sample9, false, zScoreNormalization = true, validation = true)
    test(kLow, true, samples, sample9, false, zScoreNormalization = true, validation = true)
